# Мобильное приложение для АПОФЕОЗ (reference-only)

Этот каталог не используется как исполняемое приложение.

Назначение: хранить ссылку на исходный дизайн и краткую сводку UI-токенов для будущих задач.
...
- Каталог используется только как архивный дизайн-референс.
